...
def decrypt_button_action():
    ...
    try:
        ...
        save_path = filedialog.asksaveasfilename(title="Save Decrypted Image", defaultextension=".png", filetypes=[("Image Files", ".png;.jpg;.jpeg;.bmp")])
...
img = Image.open("encryption logo.png")  # Replace with your image file path
resized_img = img.resize((24, 24), Image.LANCZOS)  # Resize to 24x24 pixels
...
img = Image.open("decryption logo.png")  # Replace with your image file path
resized_img = img.resize((24, 24), Image.LANCZOS)  # Resize to 24x24 pixels
