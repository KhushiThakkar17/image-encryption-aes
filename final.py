...
def decrypt_image(encrypted_data, password, salt, iv, save_path):
    ...
    try:
        ...
        # Verify the saved image by opening it with Pillow
        img = Image.open(save_path)
        img.verify()  # Check if image is valid (raises an exception if not)
...
def decrypt_button_action():
    ...
    try:
        ...
        save_path = filedialog.asksaveasfilename(
            title="Save Decrypted Image", filetypes=[("Image Files", ".png;.jpg;.jpeg;.bmp")])
